...
public class MainController {
    ...
    public ResponseEntity<FindPopularPostsResponse> findPopularPosts(@PageableDefault(size = 5, sort = "id", direction = Sort.Direction.ASC) Pageable pageable) {
        ...
        PostResponse post1 = new PostResponse(101, "루피는 연예인", LocalDateTime.now(), "postImage1", "화려한 조명이 루피를 감싸네");
        PostResponse post2 = new PostResponse(102, "루피는 배고파", LocalDateTime.now(), "postImage2", "군침이 싸악 도노");
        PostResponse post3 = new PostResponse(103, "루피 보호 위원회", LocalDateTime.now(), "postImage3", "끊임없이 고통 받는 루피를 쉬게 도와주세요!");
        PostResponse post4 = new PostResponse(104, "프론트엔드 짱", LocalDateTime.now(), "postImage4", "열정!열정!열정!");

        // popular post author example
        PopularPostMemberResponse member1 = new PopularPostMemberResponse(11, "루피루", "rupeeImg1");
        PopularPostMemberResponse member2 = new PopularPostMemberResponse(12, "헝그리 루피", "rupeeImg2");
        PopularPostMemberResponse member3 = new PopularPostMemberResponse(13, "루못미", "rupeeImg3");
        PopularPostMemberResponse member4 = new PopularPostMemberResponse(14, "moon", "yeoljeongImg");
    ...
    public ResponseEntity<FindMembersResponse> findMembers(@RequestParam("name") String memberName, @PageableDefault(size = 8, sort = "name", direction = Sort.Direction.ASC) Pageable pageable) {
        ...
        FindMemberResponse member3 = new FindMemberResponse(1033, memberName, "rupeeImg3", 1040);
    ...
    public ResponseEntity<FindPostsResponse> findPosts(@RequestParam("name") String postName, @PageableDefault(size = 8, sort = "title", direction = Sort.Direction.ASC) Pageable pageable) {
        ...
        PostResponse post3 = new PostResponse(33, postName, LocalDateTime.now(), "hungryImg3", "점심은 미역국");
